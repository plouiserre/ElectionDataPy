...
class CreatorCandidateDataTest(BaseUnitTest):
    ...
    def test_creator_candidate_data_factory_first_line(self) :        
        ...
        candidate_data_check = [1, "Ain", 5, "5ème circonscription", 1, "Ain", "CROZET", "Sylvie", "F", 1, "Profession intermédiaire de la santé et du travail social",  datetime.datetime(1962,6,3), False]     
    ...
    def test_creator_candidate_data_factory_second_line(self):
        ...
        candidate_data_check = [2, "Aisne", 2, "2ème circonscription", 2, "Aisne", "LEPEUPLE", "Eric", "M", 10, "Commerçant et assimilé",  datetime.datetime(1971,11,5), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_territoires_de_belfort(self):
        ...
        candidate_data_check = [90, "Territoire de Belfort", 1, "1ère circonscription", 90, "Territoire de Belfort", "GRUDLER", "Thiebaud", "M", 8, "Personne diverse sans activité professionnelle de moins de 60 ans (sauf retraité)",  datetime.datetime(1993,4,16), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_cotes_d_or(self) : 
        ...
        candidate_data_check = [21, "Côte-d'Or", 1, "1ère circonscription", 21, "Côte-d'Or", "MARTIN", "Didier", "M", 8, "Profession intermédiaire de la santé et du travail social",  datetime.datetime(1956,8,20), True]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_corsica(self):
        ...
        candidate_data_check = [20, "Corse", 1, "1ère circonscription", 20, "Corse", "LIPPLER", "Walter", "M", 14, "Cadre de la fonction publique",  datetime.datetime(1961,6,2), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_guadeloupe(self):
        ...
        candidate_data_check = [971, "Guadeloupe", 1, "1ère circonscription", 971, "Guadeloupe", "NABAJOTH", "Alix", "M", 4, "Cadre de la fonction publique",  datetime.datetime(1973,11,11), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_martinique(self):
        ...
        candidate_data_check = [972, "Martinique", 1, "1ère circonscription", 972, "Martinique", "TABAR", "Jonathan", "M", 13, "Employé civil et agent de service de la fonction publique",  datetime.datetime(1987,10,11), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_guyane(self):
        ...
        candidate_data_check = [973, "Guyane", 1, "1ère circonscription", 973, "Guyane", "MADÈRE", "Christophe", "M", 4, "Professeur, profession scientifique",  datetime.datetime(1971,7,18), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_reunion(self):
        ...
        candidate_data_check = [974, "La Réunion", 1, "1ère circonscription", 974, "La Réunion", "SISTERON", "Murielle", "F", 12, "Profession libérale",  datetime.datetime(1987,2,16), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_mayotte(self):
        ...
        candidate_data_check = [976, "Mayotte", 1, "1ère circonscription", 976, "Mayotte", "AOUNY", "Yasmina", "F", 4, "Professeur, profession scientifique",  datetime.datetime(1986,3,31), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_nouvelle_caledonie(self):
        ...
        candidate_data_check = [988, "Nouvelle-Calédonie", 1, "1ère circonscription", 988, "Nouvelle-Calédonie", "GIL", "Antoine", "M", 13, "Policier et militaire",  datetime.datetime(1956,5,26), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_polynesie_francaise(self):
        ...
        candidate_data_check = [987, "Polynésie française", 1, "1ère circonscription", 987, "Polynésie française", "HAITI", "Pascale", "F", 13, "Profession libérale",  datetime.datetime(1972,4,3), False]     
        self.assert_candidate_model(candidate_data_check, model)
    ...
    def test_creator_candidate_data_factory_saint_pierre_et_miquelon(self):
        ...
        candidate_data_check = [975, "Saint-Pierre-et-Miquelon", 1, "1ère circonscription", 975, "Saint-Pierre-et-Miquelon", "GASTON", "Olivier", "M", 4, "Cadre administratif et commercial d'entreprise",  datetime.datetime(1981,6,30), False]     
        self.assert_candidate_model(candidate_data_check, model)        
    ...
    def test_creator_candidate_data_factory_wallis_et_futuna(self):
        ...
        candidate_data_check = [986, "Wallis et Futuna", 1, "1ère circonscription", 986, "Wallis et Futuna", "UGATAI", "Sandrine Aimée", "F", 9, "Cadre administratif et commercial d'entreprise",  datetime.datetime(1973,6,23), False]     
        self.assert_candidate_model(candidate_data_check, model)        
    ...
    def test_creator_candidate_data_factory_saint_martin_saint_barthelemy(self):
        ...
        candidate_data_check = [978, "Saint-Martin/Saint-Barthélemy", 1, "1ère circonscription", 978, "Saint-Martin/Saint-Barthélemy", "GIBBS", "Daniel", "M", 13, "Profession libérale",  datetime.datetime(1968,8,1), False]     
        self.assert_candidate_model(candidate_data_check, model)        
    ...
    def test_creator_candidate_data_factory_french_strangers(self):
        ...
        candidate_data_check = [99, "Français établis hors de France", 4, "4ème circonscription", 99, "Français établis hors de France", "GONDARD", "Cécilia", "F", 3, "Cadre administratif et commercial d'entreprise",  datetime.datetime(1980,6,4), False]     
        self.assert_candidate_model(candidate_data_check, model)        
