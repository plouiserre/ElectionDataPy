...
class ResultFirstRoundAdapterTest(unittest.TestCase): 
    ...
    def test_get_two_first_round_model_from_excel_manager(self, mock_excel_manager):
        ...
        assert_test.assert_election_data_model_from_first_round_result(election_data_check, result_first_round_datas[0])        
        ...
        assert_test.assert_election_data_model_from_first_round_result(election_data_check, result_first_round_datas[1])    
