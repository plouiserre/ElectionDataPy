...
class CreatorDepartmentTest(unittest.TestCase):
    def test_creator_department_factory_first_line(self) :
    ...
    def test_creator_department_factory_second_line(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_territoires_de_belfort(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_cotes_d_or(self) : 
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_corsica(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_guadeloupe(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_martinique(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_guyane(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_reunion(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_mayotte(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_nouvelle_caledonie(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_polynesie_francaise(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_saint_pierre_et_miquelon(self):
        creator = CreatorDepartment()
        
        model = creator.factory_method("['ZS' 'Saint-Pierre-et-Miquelon'	1 'Saint-Pierre-et-Miquelon'	3	3 'M'	'GASTON' 'Olivier'	datetime.datetime(1981,06,30) 'DVG'	'Cadre administratif et commercial d'entreprise' 'Non'	'F'	'HELENE' 'Catherine'	datetime.datetime(1970,03,27) 'Non'")
        
        self.assertEqual(975, model.number)
        self.assertEqual("Saint-Pierre-et-Miquelon", model.name)
        
        
    def test_creator_department_factory_wallis_et_futuna(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_saint_martin_saint_barthelemy(self):
        creator = CreatorDepartment()
    ...
    def test_creator_department_factory_french_strangers(self):
        creator = CreatorDepartment()
