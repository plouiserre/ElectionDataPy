...
class CreatorCandidatesTest(unittest.TestCase) : 
    ...
    def test_creator_candidates_from_first_round_data_excel_first_line(self) : 
        ...
        assert_test.assert_candidate_data_first_round_election(candidate_model_check, candidates[0])   
        
        candidate_model_check = ["XXXX","F", "ARMENJON", "Eliane","XXXX", 1161, 1.35, 2.78]     
        assert_test = AssertTest(self, 1)  
        assert_test.assert_candidate_data_first_round_election(candidate_model_check, candidates[1]) 
    ...
    def test_creator_candidates_from_first_round_data_excel_second_line(self) : 
        ...
        assert_test = AssertTest(self, 1)  
        assert_test.assert_candidate_data_first_round_election(candidate_model_check, candidates[2])   
        
        candidate_model_check = ["XXXX","F", "MEYER", "Claudine","XXXX", 0, 0.0, 0.0]     
        assert_test = AssertTest(self, 1)  
        assert_test.assert_candidate_data_first_round_election(candidate_model_check, candidates[3]) 
