...
class DepartmentModelTest(unittest.TestCase):
    ...
    def test_to_department_model_corsica(self):
        ...
        model.to_department_model("['2A' 'Corse-du-Sud'	'01' '1ère circonscription'	2	15	'M'	'LIPPLER'	'Walter'	datetime.datetime(1961, 02, 5, 0, 0) 'DSV'	'Cadre de la fonction publique'	'Non'	'M'	'GOUILLON'	'Sylvain'	datetime.datetime(1960,8 ,8, 0, 0)	'Non'")
    ...
    def test_to_department_model_guadeloupe(self):
        ...
        model.to_department_model("['ZA' 'Guadeloupe' '01' '1ère circonscription'	4	37	'M'	'NABAJOTH'	'Alix'	datetime.datetime(1973, 11, 11, 0, 0) 'DVG'	'Cadre de la fonction publique'	'Non'	'F'	'BARTEBIN-SOURHOU'	'Huguette'	datetime.datetime(1971, 12, 3, 0, 0)	'Non'")
    ...
    def test_to_department_model_martinique(self):
        ...
        model.to_department_model("['ZB' 'Martinique' '01' '1ère circonscription' 1	2	'M'	'TABAR'	'Jonathan'	datetime.datetime(1987,10, 11, 0, 0) 'DVD'	'Employé civil et agent de service de la fonction publique'	'Non'	'F'	'JOSEPH'	'Joannifer' datetime.datetime(1996,12,11) 'Non'")
    ...
    def test_to_department_model_guyane(self):
        ...
        model.to_department_model("['ZC' 'Guyane' '01'	'1ère circonscription'	11	7 'M' 'MADÈRE' 'Christophe' datetime.datetime(1971,07,18) 'DVG'	'Professeur, profession scientifique'	'Non'	'F'	'BRIQUET'	'Ruth'	datetime.datetime(1993,05,06) 'Non'")
    ...
    def test_to_department_model_reunion(self):
        ...
        model.to_department_model("['ZD' 'La Réunion' '01' '1ère circonscription' 2	9 'F' 'SISTERON' 'Murielle'	datetime.datetime(1987,02,16) 'LR'	'Profession libérale' 'Non'	'M'	'SERVIABLE'	'Mario'	datetime.datetime(1949,05,23) 'Non'")
    ...
    def test_to_department_model_mayotte(self):
        ...
        model.to_department_model("['ZM' 'Mayotte'	'01' '1ère circonscription'	2	21	'F'	'AOUNY'	'Yasmina'	datetime.datetime(1986,03,31) 'DVG'	'Professeur, profession scientifique'	'Non'	'M'	'BACAR'	'Assoumani'	datetime.datetime(1971,04,01) 'Non'")
    ...
    def test_to_department_model_nouvelle_caledonie(self):
        ...
        model.to_department_model("['ZN' 'Nouvelle-Calédonie'	'01' '1ère circonscription'	1	2	'M'	'GIL' 'Antoine'	datetime.datetime(1956,26,05) 'DVD'	'Policier et militaire'	'Non'	'M'	'QUINET' 'Stéphane'	datetime.datetime(1965,25,12) 'Non'")
    ...
    def test_to_department_model_polynesie_francaise(self):
        ...
        model.to_department_model("['ZP' 'Polynésie française'	'01' '1ère circonscription'	1	15	'F'	'HAITI'	'Pascale' datetime.datetime(1972,04,03) 'DVD' 'Profession libérale'	'Non' 'F'	'NOUVEAU' 'Lydia'	datetime.datetime(1959,27,02) 'Non'")
    ...
    def test_to_department_model_saint_pierre_et_miquelon(self):
        ...
        model.to_department_model("['ZS' 'Saint-Pierre-et-Miquelon'	'01' 'Saint-Pierre-et-Miquelon'	3	3 'M'	'GASTON' 'Olivier'	datetime.datetime(1981,06,30) 'DVG'	'Cadre administratif et commercial d'entreprise' 'Non'	'F'	'HELENE' 'Catherine'	datetime.datetime(1970,03,27) 'Non'")
    ...
    def test_to_department_model_wallis_et_futuna(self):
        ...
        model.to_department_model("['ZW' 'Wallis et Futuna'	01	'1ère circonscription'	3	7	'F'	'UGATAI' 'Sandrine' 'Aimée'	datetime.datetime(1976,06,23) 'DVC' 'Cadre administratif et commercial d'entreprise'	'Non' 'F' 'TAUVALE ÉPOUSE HANISI' 'Akata'	datetime.datetime(1976,03,27) 'Non'")
    ...
    def test_to_department_model_saint_martin_saint_barthelemy(self):
        ...
        model.to_department_model("['ZX' 'Saint-Martin/Saint-Barthélemy' '01' '1ère circonscription'	2	3	'M'	'GIBBS'	'Daniel'	datetime.datetime(1968,08,01)	'DVD'	'Profession libérale'	'Non'	'M'	'GREAUX'	'Thomas'	datetime.datetime(1991,27,08)	'Non'")
    ...
    def test_to_department_model_french_strangers(self):
        ...
        model.to_department_model("['ZZ' 'Français établis hors de France' '04'	'4ème circonscription'	5	64	'F'	'GONDARD' 'Cécilia'	datetime.datetime(1980,06,04) 'NUP'	'Cadre administratif et commercial d'entreprise' 'Non'	'F'	'LIBEAUT'	'Catherine'	datetime.datetime(1963,09,26) 'Non'")
