...
class CreatorCandidatesSecondRoundTest(unittest.TestCase) : 
    def test_creator_candidates_from_second_round_data_excel_first_line(self) : 
        ...
        last_candidates_model_created = creator.last_elements_created
        ...
        assert_test.assert_election_data_second_round_result(candidate_model_check, last_candidates_model_created[0])   
        ...
        assert_test.assert_election_data_second_round_result(candidate_model_check, last_candidates_model_created[1])         
    ...
    def test_creator_candidates_from_second_round_data_excel_second_line_with_last_election_data_model(self) :
        ...
        last_first_candidate_model_check = ["XXXX", "M", "GUÉRAUD", "Sébastien","XXXX", 108, 17.88, 39.27]     
        assert_test.assert_election_data_second_round_result(last_first_candidate_model_check, last_candidates_model_created[0])   
        
        candidate_model_check = ["XXXX","M", "BRETON", "Xavier","XXXX", 270, 29.575, 65.64]     
        assert_test.assert_election_data_second_round_result(candidate_model_check, candidates[1]) 
        
        last_second_candidate_model_check = ["XXXX","M", "BRETON", "Xavier","XXXX", 167, 27.65, 60.73]     
        assert_test.assert_election_data_second_round_result(last_second_candidate_model_check, last_candidates_model_created[1]) 
    ...
    def test_creator_candidates_with_two_last_election_data_created_second_round_data(self) :
        ...
        last_first_candidate_model_check = ["XXXX", "M", "GUÉRAUD", "Sébastien","XXXX", 67, 15.02, 34.36]     
        assert_test.assert_election_data_second_round_result(last_first_candidate_model_check, last_candidates_model_created[0])   
        
        candidate_model_check = ["XXXX","M", "BRETON", "Xavier","XXXX", 398, 29.283, 65.64]     
        assert_test.assert_election_data_second_round_result(candidate_model_check, candidates[1]) 
        
        last_second_candidate_model_check = ["XXXX","M", "BRETON", "Xavier","XXXX", 128, 28.7, 65.64]     
        assert_test.assert_election_data_second_round_result(last_second_candidate_model_check, last_candidates_model_created[1]) 