...
class CreatorDepartmentTest(unittest.TestCase):
    def test_creator_department_gironde(self) : 
        ...
        election_data = ['33','Gironde','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
        
        department = creator.factory_method(election_data)
    ...
    def test_creator_department_corsica(self) : 
        creator = CreatorDepartment()
        election_data =['2A','Corse-du-Sud','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_guadeloupe(self) : 
        creator = CreatorDepartment()        
        election_data = ['ZA','Guadeloupe','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_martinique(self) : 
        creator = CreatorDepartment()
        election_data = ['ZB','Martinique','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_guyane(self) : 
        creator = CreatorDepartment()
        election_data = ['ZC','Guyane','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_la_reunion(self) : 
        creator = CreatorDepartment()
        election_data = ['ZD','La Réunion','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_mayotte(self) : 
        creator = CreatorDepartment()
        election_data = ['ZM','Mayotte','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_nouvelle_caledonie(self) : 
        creator = CreatorDepartment()
        election_data = ['ZN','Nouvelle-Calédonie','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_polynesie_francaise(self) : 
        creator = CreatorDepartment()
        election_data = ['ZP','Polynésie française','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_saint_pierre_et_miquelon(self) : 
        creator = CreatorDepartment()
        election_data = ['ZS','Saint-Pierre-et-Miquelon','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_wallis_et_futuna(self) : 
        creator = CreatorDepartment()
        election_data = ['ZW','Wallis et Futuna','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_saint_martin_saint_barthelemy(self) : 
        creator = CreatorDepartment()
        election_data = ['ZX','Saint-Martin/Saint-Barthélemy','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
    ...
    def test_creator_department_hors_de_france(self) : 
        creator = CreatorDepartment()
        election_data = ['ZZ','Français établis hors de France','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX','XXXXX']
