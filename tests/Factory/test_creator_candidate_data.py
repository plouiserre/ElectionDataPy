...
#TODO refaire cette classe    
    ...
    def test_creator_candidate_data_factory_mayotte(self):
        ...
        model = creator.factory_method("['ZM' 'Mayotte'	1 '1ère circonscription'	2	21	'F'	'AOUNY'	'Yasmina' 'Myriam' '1986-03-31 00:00:00' 'DVG'	'Professeur, profession scientifique'	'Non'	'M'	'BACAR'	'Assoumani' 'Toufik'	datetime.datetime(1971,04,01) 'Non'")
