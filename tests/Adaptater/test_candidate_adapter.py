...
class CandidateAdapterTest(BaseUnitTest):
    ...
    def test_get_six_candidatedatamodels_from_excel_manager(self, mock_excel_manager) : 
        ...
        first_candidate_data_check = [1, "Ain", 1, "1ère circonscription", 1, "Ain", "BELLON", "Julien", "M", 15, '"Cadre administratif et commercial d\'entreprise"',  datetime.datetime(1978,6,11), False, 'F', 'JEAN-LOUIS', 'Fabienne', datetime.datetime(1954, 7, 13, 0, 0), False]     
        ...
        fourth_candidate_data_check = [6, "Alpes-Maritimes", 6, "6ème circonscription", 6, "Alpes-Maritimes", "TRASTOUR-ISNART", "Laurence", "F", 12, "Cadre de la fonction publique",  datetime.datetime(1972,3,6), True, 'M', 'COANUS', 'Christophe', datetime.datetime(1978, 12, 1, 0, 0), False]     
        fifth_candidate_data_check = [10, "Aube", 1, "1ère circonscription", 10, "Aube", "GUITTON", "Jordan", "M", 16, "Profession intermédiaire administrative de la fonction publique",  datetime.datetime(1995,1,30), False, 'F', 'DA ROCHA', 'Katia', datetime.datetime(1974, 3, 31, 0, 0), False]     
