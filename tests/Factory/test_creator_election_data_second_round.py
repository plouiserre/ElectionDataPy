...
class CreatorElectionDataSecondRoundTest(unittest.TestCase) : 
    def test_creator_result_city_second_round_first_line(self) : 
        ...
        election_data_check = [1, 'Ain', 1, '1ère circonscription', 2, 'Complet', 327, 172, 52.6, 155, 47.4, 4, 1.22, 2.58, 5, 1.53, 3.23, 146, 44.65, 94.19, 8, 'M', 'GUÉRAUD', 'Sébastien', 'NUP', 43, 13.15, 29.45, 'nan', '3.0', 'M', 'BRETON', 'Xavier', 'LR', 103, 31.5, 70.55, 'nan', 'nan']
    ...
    def test_creator_result_city_second_round_cantal_district_line(self) : 
        ...
        election_data_check = [15, 'Cantal', 2, '2ème circonscription', 2, 'Complet', 242, 107, 44.21, 135, 55.79, 11, 4.55, 8.15, 2, 0.83, 1.48, 122, 50.41, 90.37, 2, 'F', 'GUIBERT', 'Martine', 'ENS', 39, 16.12, 31.97, 'nan', '1.0', 'M', 'BONY', 'Jean-Yves', 'LR', 83, 34.3, 68.03, 'nan', 'nan']
        assert_test = AssertTest(self, 1)
        assert_test.assert_election_data_model_from_rounds_result(election_data_check, election_data) 